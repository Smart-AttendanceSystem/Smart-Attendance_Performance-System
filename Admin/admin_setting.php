...
<div class="px-md mt-auto border-t border-on-primary-fixed-variant/20 pt-lg">
...
<a class="flex items-center gap-md px-md py-sm text-on-primary hover:text-on-primary transition-colors duration-200" href="../auth/logout.php">
<span class="material-symbols-outlined">logout</span>
<span class="font-label-caps text-label-caps">Logout</span>
</a>
</div>
</aside>
<header class="fixed top-0 right-0 w-full md:w-[calc(100%-260px)] h-16 bg-surface flex justify-between items-center px-lg h-16 z-40 border-b border-outline-variant shadow-sm">
...
<input class="w-full pl-10 pr-4 py-2 bg-surface-container-low border border-outline-variant rounded-full text-body-sm focus:outline-none focus:ring-2 focus:ring-secondary/50 transition-all" id="global-search" placeholder="Search employees..." type="text"/>
<div id="search-results" class="absolute top-full left-0 right-0 mt-1 bg-surface-container-lowest border border-outline-variant rounded-xl shadow-lg hidden max-h-64 overflow-y-auto z-50"></div>
</div>
</div>
<div class="flex items-center gap-md">
<div class="flex items-center gap-sm ml-md">
<img class="w-10 h-10 rounded-full border-2 border-secondary object-cover" src="<?= !empty($admin['avatar']) ? htmlspecialchars($admin['avatar']) : $defaultAvatar ?>"/>
</div>
</div>
</header>
<main class="md:ml-[260px] pt-16 min-h-screen bg-background">
...
<input class="w-full border border-outline-variant rounded-lg p-sm font-body-md focus:border-secondary focus:ring-0" name="name" type="text" value="<?= htmlspecialchars($admin['name'] ?? '') ?>" required/>
</div>
<div class="space-y-base">
<label class="font-label-caps text-label-caps text-on-surface-variant">EMAIL ADDRESS</label>
<input class="w-full border border-outline-variant rounded-lg p-sm font-body-md focus:border-secondary focus:ring-0" name="email" type="email" value="<?= htmlspecialchars($admin['email'] ?? '') ?>" required/>
</div>
<div class="space-y-base">
<label class="font-label-caps text-label-caps text-on-surface-variant">JOB TITLE</label>
<input class="w-full border border-outline-variant rounded-lg p-sm font-body-md focus:border-secondary focus:ring-0" name="job_title" type="text" value="<?= htmlspecialchars($admin['job_title'] ?? '') ?>"/>
</div>
<div class="space-y-base">
<label class="font-label-caps text-label-caps text-on-surface-variant">DEPARTMENT</label>
<select class="w-full border border-outline-variant rounded-lg p-sm font-body-md focus:border-secondary focus:ring-0" name="department_id">
...
<?php endforeach; ?>
<?php else: ?>
<tr><td class="px-md py-sm text-on-surface-variant" colspan="2">No positions defined yet.</td></tr>
<?php endif; ?>
</tbody>
</table>
</div>
...
<?php endforeach; ?>
<?php else: ?>
<tr><td class="px-md py-sm text-on-surface-variant" colspan="3">No employees found.</td></tr>
<?php endif; ?>
</tbody>
</table>
</div>
