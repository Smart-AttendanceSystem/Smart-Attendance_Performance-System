...
<!-- Main Content Area -->
<main class="flex-1 ml-[260px] flex flex-col h-screen overflow-y-auto">
<!-- TopNavBar Component -->
...
<h2 class="font-headline-sm text-headline-sm font-bold text-primary">Welcome, Kay 👋</h2>
<p class="font-body-sm text-body-sm text-on-surface-variant">Employee ID : YGN-0005</p>
</div>
</div>
...
<img src="https://i.pinimg.com/736x/e6/41/f7/e641f7816f326ad132ce6ae01543127a.jpg" class="w-22 h-22 rounded-full border-4 border-surface-container overflow-hidden" alt="">
</div>
<div class="hidden sm:flex flex-col">
<span class="font-body-md font-semibold text-on-surface">Kay Ko</span>
<span class="font-body-sm text-[11px] text-on-surface-variant">Employee</span>
</div>
...
<input class="w-full px-md py-sm bg-surface-container-low border border-outline-variant rounded-lg font-body-md text-on-surface focus:ring-2 focus:ring-secondary/20 focus:border-secondary transition-all outline-none" disabled="" type="text" value="YGN-0005"/>
</div>
<div class="space-y-xs">
<label class="font-label-caps text-label-caps text-on-surface-variant uppercase">Email</label>
<input class="w-full px-md py-sm bg-surface-container-low border border-outline-variant rounded-lg font-body-md text-on-surface focus:ring-2 focus:ring-secondary/20 focus:border-secondary transition-all outline-none" disabled="" type="email" value="Kay@gmail.com"/>
</div>
</div>
<div class="space-y-xs">
...
<textarea class="w-full px-md py-sm border border-outline-variant rounded-lg font-body-md text-on-surface focus:ring-2 focus:ring-secondary/20 focus:border-secondary transition-all outline-none resize-none" placeholder="Enter reason here..." rows="6">I forgot my current password and cannot login to my account.</textarea>
<div class="flex justify-end">
<span class="font-body-sm text-[11px] text-on-surface-variant">6/250</span>
</div>
</div>
<div class="pt-sm">
<button class="bg-[#0061ff] hover:bg-[#0052d9] text-white px-xl py-sm rounded-lg font-label-caps text-label-caps tracking-wide flex items-center gap-sm transition-all transform active:scale-95 shadow-lg shadow-blue-500/20">
...
<td class="px-md py-md font-body-sm text-on-surface">15 Oct 202-, 10:45 AM</td>
<td class="px-md py-md font-body-sm text-on-surface">Forgotten password</td>
<td class="px-md py-md">
<span class="inline-flex items-center px-2 py-0.5 rounded-full bg-secondary-container/30 text-on-secondary-container font-label-caps text-[10px]">APPROVED</span>
</td>
</tr>
<tr class="hover:bg-surface-container/30 transition-colors">
<td class="px-md py-md font-body-sm text-on-surface">22 Nov 202-, 09:12 AM</td>
<td class="px-md py-md font-body-sm text-on-surface">Account Locked</td>
<td class="px-md py-md">
<span class="inline-flex items-center px-2 py-0.5 rounded-full bg-error-container/30 text-on-error-container font-label-caps text-[10px]">REJECTED</span>
</td>
</tr>
</tbody>
</table>
...
<script>
        ...
        const submitBtn = document.querySelector('button.bg-[#0061ff]');
        if (submitBtn) {
            submitBtn.addEventListener('click', function() {
                const btnContent = this.innerHTML;
                this.disabled = true;
                this.innerHTML = `<span class="animate-spin material-symbols-outlined text-sm">refresh</span> <span class="font-bold">PROCESSING...</span>`;
                
                setTimeout(() => {
                    this.innerHTML = `<span class="material-symbols-outlined text-sm">check_circle</span> <span class="font-bold">REQUEST SENT</span>`;
                    this.classList.remove('bg-[#0061ff]');
                    this.classList.add('bg-secondary');
                }, 2000);
            });
        }

        // Toggling notification indicator (demo purpose)
        setInterval(() => {
